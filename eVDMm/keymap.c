...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, ST_MACRO_0,     ST_MACRO_1,     ST_MACRO_2,     ST_MACRO_3,     ST_MACRO_4,     KC_TRANSPARENT,                                 KC_HOME,        KC_TRANSPARENT, TD(DANCE_46),   TD(DANCE_47),   TD(DANCE_48),   KC_TRANSPARENT, KC_TRANSPARENT, 
    ST_MACRO_5,     ST_MACRO_6,     ST_MACRO_7,     ST_MACRO_8,     ST_MACRO_9,     ST_MACRO_10,    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_I,           KC_O,           KC_P,           KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, 
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_RIGHT) SS_DELAY(50) SS_TAP(X_DOWN) SS_DELAY(50) SS_TAP(X_UP) SS_DELAY(50) SS_TAP(X_UP) SS_DELAY(50) SS_TAP(X_LEFT) SS_DELAY(50) SS_TAP(X_DOWN) SS_DELAY(50) SS_TAP(X_DOWN));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(60) SS_TAP(X_RIGHT) SS_DELAY(60) SS_TAP(X_DOWN) SS_DELAY(60) SS_TAP(X_DOWN) SS_DELAY(60) SS_TAP(X_DOWN));
    }
    break;
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(60) SS_TAP(X_RIGHT) SS_DELAY(60) SS_TAP(X_DOWN) SS_DELAY(60) SS_TAP(X_UP));
    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(60) SS_TAP(X_RIGHT) SS_DELAY(60) SS_TAP(X_DOWN) SS_DELAY(60) SS_TAP(X_DOWN) SS_DELAY(60) SS_TAP(X_RIGHT));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
