...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                                           KC_HOME,        KC_TRANSPARENT, TD(DANCE_46),   TD(DANCE_47),   TD(DANCE_48),   KC_TRANSPARENT, KC_TRANSPARENT, 
...
const uint16_t PROGMEM HD_AMR_RIFLE[] = { KC_A, KC_S, COMBO_END};
const uint16_t PROGMEM HD_AUTO_CANNON[] = { KC_A, KC_C, COMBO_END};
const uint16_t PROGMEM HD_120_MM[] = { KC_AT, KC_1, COMBO_END};
const uint16_t PROGMEM HD_380_MM[] = { KC_AT, KC_2, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_500[] = { KC_E, KC_5, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_STRIKE[] = { KC_E, KC_1, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_STRAFE[] = { KC_E, KC_2, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_CLUSTER[] = { KC_E, KC_3, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_NAPALM[] = { KC_E, KC_4, COMBO_END};
const uint16_t PROGMEM HD_EAGLE_110_PODS[] = { KC_E, KC_6, COMBO_END};
const uint16_t PROGMEM HD_ORC_STRIKE[] = { KC_AT, KC_GRAVE, COMBO_END};
const uint16_t PROGMEM HD_ORB_LASER[] = { KC_AT, KC_3, COMBO_END};
const uint16_t PROGMEM HD_ORB_AIRBURST[] = { KC_AT, KC_4, COMBO_END};
const uint16_t PROGMEM HD_ORB_WALKER[] = { KC_AT, KC_5, COMBO_END};
const uint16_t PROGMEM HD_ORBITAL_EMP[] = { KC_AT, KC_6, COMBO_END};
const uint16_t PROGMEM HD_ROCKET_SENTRY[] = { KC_S, KC_R, COMBO_END};
const uint16_t PROGMEM HD_GATLING_SENTRY[] = { KC_S, KC_G, COMBO_END};
const uint16_t PROGMEM HD_ARC_THROWER[] = { KC_A, KC_Z, COMBO_END};
const uint16_t PROGMEM HD_GUARD_DOG[] = { KC_G, KC_D, COMBO_END};
const uint16_t PROGMEM HD_GUARD_ROVER[] = { KC_G, KC_R, COMBO_END};
const uint16_t PROGMEM HD_DOG_BREATH[] = { KC_G, KC_B, KC_D, COMBO_END};
const uint16_t PROGMEM HD_MACHINE_GUN[] = { KC_F, KC_A, COMBO_END};
const uint16_t PROGMEM HD_JUMP_PACK[] = { KC_V, KC_A, COMBO_END};
const uint16_t PROGMEM HD_HELL_BOMB[] = { KC_H, KC_B, COMBO_END};
const uint16_t PROGMEM HD_REINFORCE[] = { KC_1, KC_2, KC_3, COMBO_END};

combo_t key_combos[COMBO_COUNT] = {
    COMBO(combo0, TO(3)),
    COMBO(combo1, TO(0)),
    COMBO(callAMR, HD_AMR_RIFLE),
    COMBO(HD_AUTO_CANNON, HD_AUTO_CANNON),
    COMBO(HD_120_MM, HD_120_MM),
    COMBO(HD_380_MM, HD_380_MM),
    COMBO(HD_EAGLE_500, HD_EAGLE_500),
    COMBO(HD_EAGLE_STRIKE, HD_EAGLE_STRIKE),
    COMBO(HD_EAGLE_STRAFE, HD_EAGLE_STRAFE),
    COMBO(HD_EAGLE_CLUSTER, HD_EAGLE_CLUSTER),
    COMBO(HD_EAGLE_NAPALM, HD_EACLE_CLUSTER),
    COMBO(HD_EAGLE_110_PODS, HD_EAGLE_110_PODS),
    COMBO(HD_ORC_STRIKE, HD_ORC_STRIKE),
    COMBO(HD_ORB_LASER, HD_ORB_LASER),
    COMBO(HD_ORB_AIRBURST, HD_AUTO_CANNON),
    COMBO(HD_ORB_WALKER, HD_ORB_WALKER),
    COMBO(HD_ORBITAL_EMP, HD_ORBITAL_EMP),
    COMBO(HD_ROCKET_SENTRY, HD_ROCKET_SENTRY),
    COMBO(HD_GATLING_SENTRY, HD_GATLING_SENTRY),
    COMBO(HD_ARC_THROWER,HD_jARC_THROWER),
    COMBO(HD_GUARD_DOG, HD_GUARD_DOG),
    COMBO(HD_GUARD_ROVER, HD_GUARD_ROVER),
    COMBO(HD_DOG_BREATH, HD_HELL_BOMB),
    COMBO(HD_MACHINE_GUN, HD_MACHINE_GUN),
    COMBO(HD_JUMP_PACK, HD_JUMP_PACK),
    COMBO(HD_HELL_BOMB, HD_HELL_BOMB),
    COMBO(HD_REINFORCE, HD_REINFORCE),
    COMBO(combo26, HD_JUMP_PACK),
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case HD_AUTO_CANNON:
    if (record->event.pressed) {
      SEND_STRING(SS_DOWN(X_DOWN) SS_DELAY(25) SS_UP(X_DOWN) SS_DELAY(55) SS_DOWN(X_LEFT) SS_DELAY(25) SS_UP(X_LEFT) SS_DELAY(55) SS_DOWN(X_DOWN) SS_DELAY(25) SS_UP(X_DOWN) SS_DELAY(55) SS_DOWN(X_UP) SS_DELAY(25) SS_UP(X_UP) SS_DELAY(55) SS_DOWN(X_RIGHT) SS_DELAY(25) SS_UP(X_RIGHT));
    }
    break;
    case HD_ARC_JTHROWER:
    if (record->event.pressed) {
