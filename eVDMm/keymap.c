...
combo_t key_combos[COMBO_COUNT] = {
    ...
    COMBO(C_HD_ARC_THROWER,HD_jARC_THROWER),
    COMBO(C_HD_GUARD_DOG, HD_GUARD_DOG),
    COMBO(C_HD_GUARD_ROVER, HD_GUARD_ROVER),
    COMBO(C_HD_DOG_BREATH, HD_HELL_BOMB),
