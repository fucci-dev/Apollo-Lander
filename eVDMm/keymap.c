...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_1:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_LEFT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_DOWN));
    }
    break;
    case ST_MACRO_2:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_DOWN));
    }
    break;
    case ST_MACRO_3:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_UP));
    }
    break;
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_RIGHT));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_LEFT));
    }
        break;
    case ST_MACRO_7:
    if (record->event.pressed) {
        SEND_STRING(SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN) SS_DELAY(120) SS_TAP(X_UP) SS_DELAY(120) SS_TAP(X_RIGHT) SS_DELAY(120) SS_TAP(X_DOWN));
    }
    break;
    case ST_MACRO_G:
    if (record->event.pressed) {
